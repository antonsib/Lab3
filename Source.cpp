...
void TEST1() {//тест к 3 лабораторной
	...
	if (object3.getlength() == object2.getlength()) {
		...
		if (flag == 1)
			cout << "object3=object2" << endl <<"Object3- "<< object3 << "Object2- " << object2 << endl;
	...
	if (object4.getlength() == object1.getlength()) {
		...
		if (flag == 1)
			cout << "object4=object1" << endl << "Object4- "<< object4 << "Object1- " << object1 << endl;
		else cout << "Error with program!";
	}
	Number object5;
	f >> object5;
	...
	if (object6.getlength() == object9.getlength()) {
		...
		if (flag == 1)
			cout << "object6=object9" << endl << "Object6- " << object6 << "Object9- " << object9 << endl;
		else cout << "Error with program!";
	}
	if (object7.getlength() == object10.getlength()) {
		...
		if (flag == 1)
			cout << "object7=object10" << endl << "Object7- " << object7 << "Object10- " << object10 << endl;
		else cout << "Error with program!";
	}
	if (object8.getlength() == object11.getlength()) {
		...
		if(flag==1)
		cout << "object8=object11" << endl << "Object8- " << object8 << "Object11- " << object11 << endl;
		else cout << "Error with program!";
	}
	Number object12;
